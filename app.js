...
function cambiarVista(idDestino) {
    ...
    if (idDestino === 'view-login') {
        ...
        if (idDestino === 'view-menu-principal') {
            document.getElementById('header-title').textContent = "Braun Agro - Menú";
...
function switchTab(tabName) {
    ...
    if (tabName === 'nuevo') {
        ...
        document.getElementById('tab-btn-historial').classList.add('active');
...
function abrirModuloCarga(tipo) {
    ...
    document.querySelectorAll(".preview").forEach(div => div.innerHTML = "📸 Sin foto");
            ...
            reader.onload = function(event) {
                ...
                img.onload = function() {
                    try {
                        ...
                        document.getElementById(previewId).innerHTML = `<img src="${compressed}" style="width:100%;height:100%;object-fit:cover;border-radius:4px;">`;
                    } catch (err) {
...
document.getElementById('filter-fecha').addEventListener('change', filtrarYRenderizarTabla);
